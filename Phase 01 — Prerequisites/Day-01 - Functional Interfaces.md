...
- **Predicate** = **P**roblem? (asks a yes/no question)
- **Function** = **F**ormula (transforms input → output)
- **Consumer** = **C**onsumes (takes, but never gives back)
- **Supplier** = **S**ource (gives, but never takes)
